...
function Myticket() {
  ...
  async function getdata(id) {
    try {
      let res = await axios.post("https://swamitravels-api.onrender.com/order/myticket", {
        id,
      });
      // console.log(res);
      setdata(res.data);
  ...
  async function getdataToday() {
    ...
    try {
      let res = await axios.post("https://swamitravels-api.onrender.com/order/myticket/today", {
        id,
      });
  ...
  async function getdataUpcoming() {
    ...
    try {
      let res = await axios.post(
        "https://swamitravels-api.onrender.com/order/myticket/upcoming",
        {
          id,
        }
      );
  ...
  async function getdataPast() {
    let id = Cookies.get("userid");
    try {
      let res = await axios.post("https://swamitravels-api.onrender.com/order/myticket/past", {
        id,
      });
  ...
  async function handledelete(ele) {
    ...
    try {
      let res = await axios.delete(
        `https://swamitravels-api.onrender.com/order/oneorder/:${userid}`
      );
      getdata(userid1);
              ...
              {today?.map((ele) => {
                return (
                  <div>
                    ...
                    <hr />
                    <h5>Arrival Time : {ele.busDetails.arrival}</h5>
                    <h5>Departure Time : {ele.busDetails.departure}</h5>
                    <hr />
                    <h5>Email : {ele?.busDetails.contactemail}</h5>
                    <h5>Phone : {ele?.busDetails.contactphone}</h5>
                    <hr />
                    <h5>
