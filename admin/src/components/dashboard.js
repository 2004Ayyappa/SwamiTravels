...
const Dashboard = () => {
  ...
  const fetchUserCount = async () => {
    try {
      const response = await axios.get("https://swamitravels-api.onrender.com/user/count");
  ...
  const fetchBusCount = async () => {
    try {
      const response = await axios.get("https://swamitravels-api.onrender.com/bus/count");
  ...
  const fetchCityCount = async () => {
    try {
      const response = await axios.get("https://swamitravels-api.onrender.com/city/count");
  ...
  const fetchOrderCount = async () => {
    try {
        const response = await axios.get("https://swamitravels-api.onrender.com/order/count");
